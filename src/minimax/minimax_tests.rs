...
fn test_moves() {
    ...
    expect!(average_leaves, "172639.75");
    expect!(
        board_moves,
        r#"
        [
            ...
            (
                ...
                [
                    ...
                    "side=White, kind=Bishop, move=[6, 1] -> [4, 3]",
            ...
            (
                ...
                [
                    ...
                    "side=Black, kind=Queen, move=[4, 3] -> [2, 1]",
                    "None: White",
            ...
            (
                ...
                [
                    ...
                    "side=White, kind=Knight, move=[7, 5] -> [6, 3]",
                    "None: Black",
                    "None: White",
                    "None: Black",
                ],
            ...
            (
                ...
                [
                    ...
                    "side=Black, kind=Knight, move=[4, 1] -> [2, 0]",
                    "side=White, kind=Queen, move=[5, 4] -> [2, 7]",
                    "side=Black, kind=King, move=[2, 6] -> [1, 6]",
                    "None: White",
                    "None: Black",
                    "None: White",
                    "side=Black, kind=Rook, move=[7, 7] -> [2, 7]",
                    "side=White, kind=Bishop, move=[6, 3] -> [2, 7]",
                    "None: Black",
                    "None: White",
                    "side=Black, kind=King, move=[1, 6] -> [2, 7]",
                    "None: White",
                    "None: Black",
                ],
            ),
            (
                ...
                [
                    ...
                    "side=Black, kind=King, move=[3, 4] -> [3, 5]",
            ...
            (
                ...
                [
                    ...
                    "side=White, kind=Pawn, move=[5, 3] -> [5, 2]",
                    "None: Black",
                    "None: White",
                    "None: Black",
                ],
            ...
            (
                ...
                [
                    ...
                    "side=White, kind=Pawn, move=[1, 3] -> [1, 2]",
            ...
            (
                ...
                191236,
                [
                    "side=White, kind=Pawn, move=[7, 5] -> [7, 4]",
                    "side=Black, kind=Pawn, move=[5, 4] -> [5, 5]",
                    "side=White, kind=Bishop, move=[6, 2] -> [3, 5]",
                    "side=Black, kind=Pawn, move=[2, 6] -> [2, 7]",
                    "None: White",
                    "side=Black, kind=Rook, move=[3, 4] -> [7, 4]",
                    "None: White",
                    "side=Black, kind=Bishop, move=[1, 3] -> [3, 5]",
                    "None: White",
                    "None: Black",
                ],
            ),
            (
                ...
                74523,
                [
                    "side=White, kind=Bishop, move=[3, 1] -> [4, 0]",
                    "side=Black, kind=Knight, move=[4, 1] -> [6, 0]",
                    "side=White, kind=Rook, move=[1, 2] -> [2, 2]",
            ...
            (
                ...
                [
                    ...
                    "side=White, kind=Pawn, move=[1, 6] -> [1, 4]",
