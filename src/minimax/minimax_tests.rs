...
fn test_moves() {
    ...
    expect!(average_leaves, "81020.336");
    expect!(
        board_moves,
        r#"
        [
            (
                ...
                [
                    ...
                    "None: White",
                    "side=Black, kind=Bishop, move=[5, 2] -> [4, 1]",
                ],
            ),
            (
                1.0,
                ...
                [
                    ...
                    "side=White, kind=Bishop, move=[6, 1] -> [5, 0]",
            ...
            (
                ...
                [
                    ...
                    "side=Black, kind=Queen, move=[4, 3] -> [1, 0]",
                    "None: White",
            ...
            (
                ...
                [
                    ...
                    "side=White, kind=Knight, move=[4, 4] -> [6, 3]",
                    "None: Black",
                ],
            ),
            (
                ...
                349517,
                [
                    "side=White, kind=Rook, move=[7, 0] -> [3, 0]",
            ...
            (
                ...
                [
                    ...
                    "side=White, kind=Bishop, move=[3, 3] -> [2, 4]",
            ...
            (
                ...
                [
                    ...
                    "side=Black, kind=Rook, move=[1, 0] -> [4, 0]",
            ...
            (
                ...
                [
                    ...
                    "side=Black, kind=Queen, move=[0, 5] -> [2, 7]",
                    "side=White, kind=Pawn, move=[3, 2] -> [4, 1]",
                    "side=Black, kind=Bishop, move=[0, 3] -> [4, 7]",
                    "side=White, kind=Rook, move=[6, 7] -> [2, 7]",
                    "None: Black",
                ],
            ),
            (
                ...
                [
                    ...
                    "side=White, kind=Knight, move=[6, 0] -> [5, 2]",
