...
fn test_moves() {
    ...
    expect!(average_leaves, "162987.75");
    expect!(
        board_moves,
        r#"
        [
            (
                ...
                [
                    ...
                    "None: Black",
                    "None: White",
                    "side=Black, kind=Rook, move=[3, 5] -> [3, 6]",
                    "None: White",
                    "None: Black",
                ],
            ),
            ...
            (
                ...
                674088,
                [
                    "side=White, kind=Rook, move=[7, 0] -> [7, 4]",
            ...
            (
                ...
                100559,
                [
                    "side=White, kind=Bishop, move=[3, 1] -> [7, 5]",
                    ...
                    "None: Black",
                    "side=White, kind=Rook, move=[6, 7] -> [6, 0]",
                    "None: Black",
                    "None: White",
                    "None: Black",
                    "None: White",
